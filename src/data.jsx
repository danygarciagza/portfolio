...
const PROJECTS = [
  {
    ...
    chips: { en: ["Ergonomics", "Accessibility", "3D model"], es: ["Ergonomía", "Accesibilidad", "Modelo 3D"] },
    body: {
  ...
  {
    slug: "coffee-ritual", category: "product", year: "2025", has3d: false, mainHeight: "300px", rot: "1.5deg",
  ...
  },
  {
    ...
    chips: { en: ["Kids", "Hygiene", "Safety"], es: ["Infantil", "Higiene", "Seguridad"] },
    body: {
  ...
  },
  {
    ...
    chips: { en: ["Logo", "Logotype"], es: ["Logo", "Logotipo"] },
    body: {
